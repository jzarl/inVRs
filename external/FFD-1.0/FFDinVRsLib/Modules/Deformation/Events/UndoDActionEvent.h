...
#ifndef UNDODACTIONEVENT_H_INCLUDED
#define UNDODACTIONEVENT_H_INCLUDED
 ...
 * @brief Encodes, decodes, and executes the undo action.
 */
class UndoDActionEvent : public ActionEvent
{
    public:
        UndoDActionEvent(unsigned int environmentBasedId);
        UndoDActionEvent();
        virtual ~UndoDActionEvent();

        typedef EventFactory<UndoDActionEvent> Factory;
...
#endif // UNDODACTIONEVENT_H_INCLUDED
