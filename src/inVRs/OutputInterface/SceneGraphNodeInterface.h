...
#ifndef SCENEGRAPHNODEINTERFACE_H_
#define SCENEGRAPHNODEINTERFACE_H_
 ...
 *
 */
class INVRS_OUTPUTINTERFACE_API SceneGraphNodeInterface {
public:
	///
	enum NODE_TYPE {
		UNDEFINED_NODE = 0, TRANSFORMATION_NODE, GEOMETRY_NODE, GROUP_NODE
	//...
	}; // NODE_TYPE
...
}; // SceneGraphNodeInterface

#endif /* SCENEGRAPHNODEINTERFACE_H_ */
