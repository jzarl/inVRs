...
function(_add_project_setup ADD_PROJECT_NAME)
	...
	set(_oneValueArgs "")
	set(_multiValueArgs SOURCES CONFIGS MODELS IMAGES DOCS OPENSG_MODULES INVRS_MODULES BOOST_MODULES)
	...
	if(ADD_PROJECT_OPENSG_MODULES)
		...
		list(APPEND ${ADD_PROJECT_NAME}_INCLUDE_DIRS ${GLUT_INCLUDE_DIRS})
