...
###############################################################################
if (NOT CMAKE_BUILDEXTERNAL_CONFIG_CMAKE_LOADED)
...
###############################################################################
# macro for adding module/tool flags in config_inVRs.cmake file
###############################################################################
macro(INVRS_ADD_EXPORTS _tool )
	...
	foreach ( var INCLUDE_DIRS LIBRARY_DIRS DEFINITIONS LIBRARIES )
		file ( APPEND ${INVRS_EXPORTS_FILE} "set (INVRS_EXPORT_${_tool}_${var} \"${INVRS_EXPORT_${_tool}_${var}}\" )\n" )
	endforeach( var INCLUDE_DIRS LIBRARY_DIRS DEFINITIONS LIBRARIES )
endmacro(INVRS_ADD_EXPORTS _tool )


###############################################################################
# Finish
###############################################################################
set (CMAKE_BUILDEXTERNAL_CONFIG_CMAKE_LOADED ON)
endif (NOT CMAKE_BUILDEXTERNAL_CONFIG_CMAKE_LOADED)
